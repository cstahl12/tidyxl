...
test_that("warns of missing sheets", {
  expect_warning(expect_error(tidy_xlsx("./examples.xlsx", c(NA, NA)),"All elements of argument 'sheets' were discarded."),  "Argument 'sheets' included NAs, which were discarded.", fixed = TRUE)
  ...
  expect_error(tidy_xlsx("./examples.xlsx", 5), "Only 4 sheet(s) found.", fixed = TRUE)
